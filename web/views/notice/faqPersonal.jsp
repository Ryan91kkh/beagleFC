	...
	<section>
		...
		<div class="container">
		  ...
		  <table class="table table-hover">
		    <thead>
		      <tr onclick="location.href='/jootopia/views/notice/faqPersonalPlus.jsp'">
		        <th>글번호</th>
		        <th>분류</th>
		        <th>제목</th>
		        <th>작성일</th>
		...
		<input type="text">&nbsp;
		<button onclick="location.href='<%=request.getContextPath()%>/views/notice/faqPersonal.jsp'">검색</button>
		</div> 
