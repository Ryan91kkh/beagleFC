	...
	<section>
		...
		<div class="container">
		  ...
		  <table class="table table-hover">
		    ...
		    <tbody>
		      <tr onclick="location.href='/jootopia/views/notice/faqTheothersPlus.jsp'">
		        <td>9</td>
		        <td>기타</td>
		        <td>기타 문의입니다</td>
		        <td>2019.04.06</td>
		...
		<input type="text">&nbsp;
		<button onclick="location.href='<%=request.getContextPath()%>/views/notice/faqTheothers.jsp'">검색</button>
		</div> 
