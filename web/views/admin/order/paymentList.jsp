			...
			<table id="searchBox"  border="1" align="center">
				...
				<tr>
					...
					<td colspan="2">
						...
						<input type="radio" name="pType" id=""><label>입금전</label>
						<input type="radio" name="pType" id=""><label>추가입금대기</label>
					</td>
				</tr>
			</table>
				...
				<table id="selectList" class="selectList" border="1">
					<tr>
						<th colspan="9" style="height: 45px; text-align: left;">
							<button class="selectBtn" onclick="oTypeChange('입금 완료')">입금 완료</button>
							<button class="selectBtn" onclick="oTypeChange('주문 취소')">주문 취소</button>
						</th>
					</tr>
					<tr>
...
<div id="memoModal" class="memoModal">
    ...
    <div class="memoModalBody">
        ...
        <table class="memoModalTable">
    		...
    		<tr>
    			<td><input type="text" name="oMemo" value="<%= "배송메시지 임시" %>"></td>
    		</tr>
    	</table>
    	<br>
