...
<body>
	...
	<section class="row">
		...
		<div id="adminSection" class="col-sm-10">
			<h3 class="title">매입완료</h3>
	    	<hr>
				<div class="searchArea">
					<table id="searchBox" border="1" align="center">
						<tr>
							<th colspan="3"
								style="background: rgb(224, 224, 224); height: 35px;">매입완료리스트</th>
						</tr>
						<tr>
							<td>검색 분류</td>
						...
						<tr>
							<td>상품 등록일</td>
							<td id="selectDate" colspan="2">&nbsp;<a href="#"
								class="btnDate" period="0"><span>오늘</span></a> <a href="#"
								class="btnDate" period="7"><span>7일</span></a> <a href="#"
								class="btnDate" period="30"><span>1개월</span></a> <a href="#"
								class="btnDate" period="90"><span>3개월</span></a> <a href="#"
								class="btnDate" period="365"><span>1년</span></a> <a href="#"
								class="btnDate" period="-1"><span>전체</span></a> &nbsp;&nbsp; <input
								type="date" id="startDate" name="startDate" class="date"<%-- value="<%= startDay %>" --%>>
								~ <input type="date" id="endDate" name="endDate" class="date"<%-- value="<%= endDay %>" --%>>
							</td>
						</tr>
						<tr>
							<td>상품 상태</td>
							<td colspan="2">&nbsp;<input type="radio" name="pType"
								id="all"><label>전체</label> <input type="radio"
								name="pType" id=""><label>판매중</label> <input
								type="radio" name="pType" id=""><label>판매안함</label>
							</td>
						</tr>
					</table>
