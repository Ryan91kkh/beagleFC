...
<body>
	...
	<section class="row">
		...
		<h3 class="title">검수 및 매입</h3>
	    	<hr>
			<br /> <br /> <br />
			<div class="col-sm-6 imgArea">
				<div id="ImgArea1">
					<img src="/jootopia/images/b1.jpg" id="Img1">					
					&nbsp;&nbsp;&nbsp; <img src="/jootopia/images/b1.jpg" id="Img2">
				</div>
				<div id="ImgArea2">
					<img src="/jootopia/images/b1.jpg" id="Img3">
					&nbsp;&nbsp;&nbsp; <img src="/jootopia/images/b1.jpg" id="Img4">
				</div>
				<div id="ImgArea3">
					<img src="/jootopia/images/b1.jpg" id="Img5">
					&nbsp;&nbsp;&nbsp; <img src="/jootopia/images/b1.jpg" id="Img6">
				</div>
			</div>
			<div class="col-sm-6">
