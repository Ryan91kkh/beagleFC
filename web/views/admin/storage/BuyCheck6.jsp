...
<body>
	...
	<section class="row">
		...
		<div class="left">
			...
			<tr>
				<div id="ImgArea1">
					<td><img src="../web/images/flower1.PNG" id="Img1" width="250"
						height="250"></td> &nbsp;&nbsp;&nbsp;
					<td><img src="../web/images/flower1.PNG" id="Img2" width="250"
						height="250"></td>
				</div>
			</tr>
			<br />
			<tr>
				<div id="ImgArea2">
					<td><img src="../web/images/flower1.PNG" id="Img3" width="250"
						height="250"></td> &nbsp;&nbsp;&nbsp;
					<td><img src="../web/images/flower1.PNG" id="Img4" width="250"
						height="250"></td>
				</div>
			</tr>
			<br />
			<tr>
				<div id="ImgArea3">
					<td><img src="../web/images/flower1.PNG" id="Img5" width="250"
						height="250"></td> &nbsp;&nbsp;&nbsp;
					<td><img src="../web/images/flower1.PNG" id="Img6" width="250"
						height="250"></td>
				</div>
			</tr>
		...
		<div class="right">
			...
			<tr><th colspan="3" style="background: rgb(224, 224, 224); height: 35px;">검수 및 매입</th></tr>
				<tr>
			...
			<table class="separate" border="1">
				<tr>
					<td width="120">매입가</td>
					<td width="500"><input type="text" size="61"></td>
				</tr>
				<tr>
					<td width="120">등급</td>
